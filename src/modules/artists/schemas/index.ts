...
export const typeArtists = gql`
  ...
  extend type Mutation {
    ...
    updateArtist(id: ID!, firstName: String!, secondName: String!, middleName: String, birthDate: String, birthPlace: String, country: String!, bands: [BandInput], instruments: [String]): Artist
